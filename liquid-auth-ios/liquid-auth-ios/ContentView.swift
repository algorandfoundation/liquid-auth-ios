...
struct ContentView: View {
    ...
    private func startSignaling(origin: String, requestId: String) {
        ...
        Task {
            do {
                try await signalService.connectToPeer(requestId: requestId, type: "answer", iceServerUrls: iceServers)
                ...
                print("Successfully connected to peer with requestId: \(requestId)")
            } catch {
